						...
						<form enctype="multipart/form-data" role="form" method="post" action="regist" name="registForm">
							<div class="form-group row">
								<label for="category" class="col-sm-3"
									style="font-size: 0.9em;">카테고리</label>
								<div class="col-sm-9">
								...
								<div class="mailbox-attachment-info" style="width: 100%;">
									<div class="input-group input-group-sm">
										...
										<input id="inputFileName" class="form-control" type="text"
											name="tempThumnail" disabled /> <input type="file"
											id="inputFile" name="thumnail" style="display: none;"
											onchange="thumnail_go();" />
									</div>
								</div>
							</div>
						</form>
...
<script>
	function thumnail_go() {
		//alert("change");
		let thumnailInput = document.querySelector("input[name='thumnail']");
